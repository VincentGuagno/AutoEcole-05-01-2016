	...
	class AddModel extends ExamsModel{
		...
		public function add_exam($NOM,$DATE_PASSAGE,$FK_ELEVE,$FK_PERMIS) {
			try {		
				...
				$qry = oci_parse($this->db, 'INSERT INTO AUTO.EXAMEN (NOM, DATE_PASSAGE,FK_PERMIS,FK_ELEVE) VALUES (:NOM,to_date(:DATE_PASSAGE, \'DD/MM/YYYY HH24:MI:SS\'),:FK_PERMIS,:FK_ELEVE)');
