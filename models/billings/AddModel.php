	...
	class AddModel extends BillingsModel{
		...
		public function add_billing($DATE_FACTURE, $PRIX, $ETAT_FACTURE, $FK_TYPE_FACTURE, $FK_ELEVE) {
			try {
				...
				$qry = oci_parse($this->db, 'INSERT INTO AUTO.FACTURATION (DATE_FACTURE, PRIX, ETAT_FACTURE, FK_TYPE_FACTURE, FK_ELEVE) VALUES (to_date(:DATE_FACTURE,\'DD/MM/YYYY\'),:PRIX,:ETAT_FACTURE,:FK_TYPE_FACTURE,:FK_ELEVE)');
