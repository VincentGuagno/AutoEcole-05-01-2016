	...
	class ModifyModel extends BillingsModel{
		...
		public function modify_facturation($DATE_FACTURE, $PRIX, $ETAT_FACTURE, $PK_FACTURATION) {
			try {
				...
				$qry = oci_parse($this->db, ("UPDATE FACTURATION SET DATE_FACTURE = TO_DATE(':DATE_FACTURE', 'DD/MM/YYYY HH24:MI:SS'), PRIX = :PRIX, ETAT_FACTURE = :ETAT_FACTURE WHERE PK_FACTURATION = :PK_FACTURATION");
