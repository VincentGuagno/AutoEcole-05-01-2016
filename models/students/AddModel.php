	...
	class AddModel extends StudentModel{
		...
		public function add_student($NOM,
			...
			try {
				...
				$qry = oci_parse($this->db,"INSERT INTO AUTO.ELEVE  (NOM, PRENOM, ADRESSE, NUM_TEL, DATE_NAISSANCE, LIEU_ETUDE, FK_FORMULES,FK_MONITEUR) VALUES ('toto','tata','rer',O5O5O5O5,TO_DATE('14-12-1992',\'DD-MM-YYYY\'),Toulouse,1,1)");			
