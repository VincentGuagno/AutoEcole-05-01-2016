<?php
	...
	class AddModel extends StudentModel{
		 ...
		 */
		public function add_student($NOM,
									 $PRENOM,
									 $ADRESSE, 
									 $NUM_TEL, 
									 $DATE_NAISSANCE, 									
			...
			try {
				...
				// $qry = oci_parse($this->db,"INSERT INTO AUTO.ELEVE  (NOM, PRENOM, ADRESSE, NUM_TEL, DATE_NAISSANCE, LIEU_ETUDE, FK_FORMULES,FK_MONITEUR) VALUES (:NOM,:PRENOM,:ADRESSE,:NUM_TEL,TO_DATE(:DATE_NAISSANCE,\'DD-MM-YYYY\'),:LIEU_ETUDE,:FK_FORMULES,:FK_MONITEUR)");
				$qry = oci_parse($this->db,"INSERT INTO \"AUTO\".\"ELEVE\" (FK_FORMULES, FK_MONITEUR, NOM, PRENOM, ADRESSE, NUM_TEL, DATE_NAISSANCE, LIEU_ETUDE) VALUES (:FK_FORMULES, :FK_MONITEUR, :NOM , :PRENOM, :ADRESSE, :NUM_TEL, TO_DATE(:DATE_NAISSANCE, 'DD/MM/YYYY'), :LIEU_ETUDE)");			
