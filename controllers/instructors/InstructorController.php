<?php
	...
	/*
	 * Instructor controller core
	 * This class is above all instructor classes
	 *
	...
	abstract class InstructorController {
		
		/**
		 * State of InstructorController
		 */
		...
		/**
		 * Initialize the InstructorController class
		 */
		public function init() {
			...
			if(file_exists(_TWIG_AUTOLOADER_)) {
				try {
					...
					$loader = new Twig_Loader_Filesystem(array(_DEPENDENCIES_DIR_, _INSTRUCTORS_VIEWS_)); 
